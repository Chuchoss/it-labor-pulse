...
| Артефакт | Путь |
|----------|------|
| OpenAPI (BFF REST; клиент → BFF `:8080`; gateway — Target) | [`api/openapi.yaml`](../../api/openapi.yaml) |
...
| 21 | [21-external-services.md](./21-external-services.md) | Реестр внешних сервисов / провайдеров (Supabase, Yandex Valkey/Redis, HH…) |
