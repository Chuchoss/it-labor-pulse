...
3. Публикация — **GitHub Pages** через workflow [`.github/workflows/docs-pages.yml`](../../../.github/workflows/docs-pages.yml) (`upload-pages-artifact` + `deploy-pages`), triggers: push `production` (+ path filter) и `workflow_dispatch`.
