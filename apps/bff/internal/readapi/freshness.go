...
const FreshnessWindow = 5 * time.Hour

// IsFresh reports whether a vacancy was published by HH in the inclusive
// rolling UTC window ending at the server-provided now. Null and future
