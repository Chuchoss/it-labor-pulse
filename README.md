...
Учебный проект аналитики IT-рынка труда: сбор вакансий (сначала HeadHunter), нормализация, анализ зарплат и спроса по ролям/регионам, тренды; позже — AI-анализ.
